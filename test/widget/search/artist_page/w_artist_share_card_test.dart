...
void main() {
  ...
  testWidgets('팔로워 수가 0보다 크면 팔로워 줄을 보여준다', (tester) async {
    await pumpCommonWidget(
      tester,
      const ArtistShareCard(artistName: '아이유', imageUrl: '', followerCount: 1234),
    );

    expect(find.text('follower_count'.tr(args: ['1234'])), findsOneWidget);
