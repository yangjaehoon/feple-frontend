...
class AsyncContentBuilder<T> extends StatelessWidget {
  ...
  Widget _buildError(BuildContext context, Object? error) {
    ...
    final errorWidget = ErrorState.network(
  ...
  Widget _buildStateWidget(BuildContext context, String message) {
    final content = EmptyState(icon: Icons.article_outlined, title: message);

    if (useListViewForEmptyState) {
      return ListView(children: [const SizedBox(height: 120), content]);
    }
