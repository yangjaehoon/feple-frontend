...
void main() {
  group('ScheduleListSkeleton 렌더링', () {
    testWidgets('기본값은 3개의 스켈레톤 항목을 보여준다', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(body: ScheduleListSkeleton())),
      );
    ...
    testWidgets('itemCount만큼 스켈레톤 항목을 보여준다', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(body: ScheduleListSkeleton(itemCount: 1))),
      );
