...
class PostService {
  ...
  Future<List<Post>> _fetchPostList(String endpoint) async {
    ...
    // 순수 배열/CursorPage(content) 어느 쪽이든 toModelList가 처리
  ...
  Future<PostCursorPage> fetchPostsPage(String boardType, {int? cursor, int size = ApiConstants.defaultPageSize, String sort = 'latest'}) =>
  ...
  /// 아티스트 게시판 페이지 조회
  Future<PostCursorPage> fetchArtistPostsPage(int artistId, {int? cursor, int size = ApiConstants.defaultPageSize}) =>
  ...
  /// 페스티벌 게시판 페이지 조회
  Future<PostCursorPage> fetchFestivalPostsPage(int festivalId, {int? cursor, int size = ApiConstants.defaultPageSize}) =>
  ...
  /// 동행구하기 게시판 페이지 조회
  Future<PostCursorPage> fetchFestivalCompanionPostsPage(int festivalId, {int? cursor, int size = ApiConstants.defaultPageSize}) =>
  ...
  /// 티켓양도 게시판 페이지 조회
  Future<PostCursorPage> fetchFestivalTicketPostsPage(int festivalId, {int? cursor, int size = ApiConstants.defaultPageSize}) =>
  ...
  Future<PostCursorPage> _fetchCursorPage(String endpoint, {int? cursor, int size = ApiConstants.defaultPageSize, String? sort}) async {
