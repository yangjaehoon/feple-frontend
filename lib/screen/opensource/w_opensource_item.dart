    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(color: context.appColors.drawerBg, border: Border.all(color: context.appColors.divider), borderRadius: BorderRadius.circular(AppDimens.radiusXs)),
